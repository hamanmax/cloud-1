...
class My_Resume_Loader {
	 ...
	 * @return void
	 */
	public function my_resume_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function my_resume_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function my_resume_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function my_resume_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->my_resume_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function my_resume_load( $class ) {
